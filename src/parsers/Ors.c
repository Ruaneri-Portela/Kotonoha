...
static struct Kotonoha_orsEvent* Kotonoha_ORS_parse_line(char* line)
{
    ...
    *end = '\0';
    ...
    case PRINT_TEXT:
    {
        ...
        int sizeFind = Kotonoha_ORS_swap_tab_null(line, &transformed);
        event->data.print_text->character = SDL_malloc((sizeFind + 1) * sizeof(char));
    ...
    case PLAY_VOICE:
    {
        ...
        {
            event->data.play_voice->character_short = SDL_malloc((sizeFind + 1) * sizeof(char));
            ...
            memcpy(event->data.play_voice->character_short, line, sizeFind * sizeof(char));
    ...
    case SetSELECT:
    {
        ...
        while (true)
        {
            ...
            event->data.set_select->options[event->data.set_select->size] = SDL_malloc(sizeStr * sizeof(char));
            ...
            memcpy(event->data.set_select->options[event->data.set_select->size], line, sizeStr * sizeof(char));
